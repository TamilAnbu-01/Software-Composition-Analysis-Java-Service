...
class ScanServiceTest {
    ...
    private static class FakeSource implements VulnerabilitySource {
        ...
        @Override
        public List<VulnerabilityRecord> findVulnerabilities(
            ...
            if (dependency.packageKey()
                    .equals("org.apache.logging.log4j:log4j-core")) {
    ...
    void scanWithOneVulnerableDependency_producesFindingAndRemediation() {
        ...
        assertEquals(
                "2.15.0",
                result.remediations().get(0).recommendedVersion()
        );
    ...
    void invalidDependencyEntry_isReportedAsErrorAndDoesNotStopTheRest() {
        ...
        assertEquals(
                ...
                "the valid entry should still be scanned"
        );
    }
    ...
    void emptyDependencyList_isAValidCleanScan() {
        ...
        ScanResult result = newService().scan(
                new ScanRequest(
                        "empty-project",
                        List.of()
                )
